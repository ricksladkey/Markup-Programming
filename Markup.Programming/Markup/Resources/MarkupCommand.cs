...
namespace Markup.Programming
{
    ...
    public class MarkupCommand : ResourceObject, ICommand
    {
        ...
        protected override void OnAttached()
        {
            ...
            var parameters = new NameDictionary(new NameValuePair("Command", this));
        ...
        public bool CanExecute(object parameter)
        {
            ...
            var parameters = new NameDictionary(new NameValuePair("CommandParamer", parameter));
        ...
        {
            TryToAttach();
            var parameters = new NameDictionary(new NameValuePair("CommandParameter", parameter));
