// Originally from: http://msdn.microsoft.com/en-us/library/aa905670.aspx

using System;
using CookComputing.XmlRpc;
using System.Net;

namespace CodePlexApi
{
    /// <summary> 
    ...
    /// CodePlex using the MetaWeblog API. 
    /// </summary>
    [XmlRpcUrl("https://www.codeplex.com/site/metaweblog")]
    public class CodePlexMetaWeblog : XmlRpcClientProtocol
    {
        ...
        /// </summary> 
        /// <param name="blogid"> This should be the string markupprogramming, which indicates that the post is being created in the user’s blog. </param> 
